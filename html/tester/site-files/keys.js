document.addEventListener("keydown",function(e){document.getElementById("audio").play();});$(document).ready(function(){$("#test").click(function(){$("use").removeClass("pressed");$("use").removeClass("pressed-key");$("use").removeClass("led");});});$(document).keyup(function(e){if($("#test").prop("checked")!==true){$("use").removeClass("pressed");$("use").removeClass("pressed-key");$("use").removeClass("led");}});$(document).keydown(function(e){if(e.keyCode==27){$("#esc use").addClass("pressed-key");$("#esc-b use").addClass("pressed");$("#out").text("esc");}
